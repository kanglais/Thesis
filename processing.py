#multiprocess code from infovis course, for parsing json files of beyonce tweets
...
def process_reponse(head, suffix, output_dir, output):
    ...
    root = head+suffix
    for path, subdirs, files in os.walk(root, onerror="None"):
        for name in files:
            minute = name[:2]
            hour = path[-2:]
            day = path[-5:-3]
...
def main():
    ...
    head = "/Users/Kellie/Desktop/09/"

    output_dir = "/Users/Kellie/Desktop/output"
